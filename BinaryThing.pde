...
static class BinaryThing {
  ...
  boolean is(Class t, int s[]) { return (blob != null) && (type == t) && Arrays.equals(size, s); }
  boolean isInt2(int NN) { return is(Integer.TYPE, new int[] { NN, NN }); }
  ...
  static BinaryThing parseFromText(String lines[], char sep, Class type) throws Exception {
    return parseFromText(lines, sep, type, null); }
  static BinaryThing parseFromText(String lines[], char sep, Class type, TConsole.Message msg) throws Exception {

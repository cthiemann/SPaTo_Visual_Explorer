...
class SVE2Document {
  ...
  void setFile(File file, boolean compressed) {
  ...
  XMLElement getColormap(XMLElement xml) {
  ...
  void generateLayouts(XMLElement xml) {  // FIXME
   ...
   */
  XMLElement readMultiPartXML(String name) {
   ...
   * respective files. */
  void writeMultiPartXML(String name, XMLElement doc) { writeMultiPartXML(name, doc, null); }
  void writeMultiPartXML(String name, XMLElement doc, HashMap<String,XMLElement[]> map) {
    if (doc == null) return;
  ...
  boolean notInMap(HashMap<String,XMLElement[]> map, String src, XMLElement child) {
  ...
  XMLElement addAutoIDs(XMLElement doc) { return addAutoIDs(doc, ""); }
  XMLElement addAutoIDs(XMLElement doc, String hashPrefix) {
    if (doc == null) return null;
   ...
   * b does not. */
  boolean equalNameAndID(XMLElement a, XMLElement b, boolean laxID) {
  ...
  Object previousOrNext(Object haystack, Object needle) {
